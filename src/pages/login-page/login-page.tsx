...
export function LoginPage() {
  ...
  const backgroundUrl = 'https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?q=80&w=1974&auto=format&fit=crop';
      ...
      <Box className="flex-1 flex items-center justify-center bg-gradient-to-r from-blue-50 to-indigo-50">
        ...
        >
          <Stack align="center" mb={rem(20)}>
            <Title order={1} style={{ color: '#1890ff', fontWeight: 700, letterSpacing: '-0.5px' }} size={rem(32)}>
          ...
          <Divider label={t('common:label.demo_accounts')} labelPosition="center" my="lg" />
          
          <Card withBorder p="xs" radius="md" mb="sm">
            <Group justify="space-between">
              <Box>
                <Text size="sm" fw={500}>Admin Account</Text>
                <Text size="xs" c="dimmed">Email: admin@example.com</Text>
                <Text size="xs" c="dimmed">Password: any password</Text>
              </Box>
              <Button 
                variant="light" 
                onClick={() => {
          ...
          <Card withBorder p="xs" radius="md">
            <Group justify="space-between">
              <Box>
                ...
                <Text size="xs" c="dimmed">Email: user@example.com</Text>
                <Text size="xs" c="dimmed">Password: any password</Text>
              </Box>
              <Button 
                variant="light" 

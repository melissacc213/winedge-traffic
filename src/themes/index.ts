...
// Export the base theme configuration for Mantine v8
// Mantine v8 handles light/dark mode automatically via CSS variables
export const themeConfig = baseTheme;

// For compatibility, export the theme config as default

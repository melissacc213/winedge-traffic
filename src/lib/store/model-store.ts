...
const MOCK_MODELS: Model[] = [
  ...
  },
  {
    ...
    description: 'Advanced model for traffic flow analysis and vehicle classification',
  },
  {
    id: 'model_5',
    ...
    description: 'Specialized model for railway safety monitoring and train tracking',
  },
];
